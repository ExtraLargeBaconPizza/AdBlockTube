...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XamarinNotBlank.Droid.TabsAdapter, XamarinNotBlank.Droid", TabsAdapter.class, __md_methods);
	}
	...
	public TabsAdapter (android.support.v4.app.FragmentManager p0)
	{
		...
		if (getClass () == TabsAdapter.class)
			mono.android.TypeManager.Activate ("XamarinNotBlank.Droid.TabsAdapter, XamarinNotBlank.Droid", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0 });
	}
